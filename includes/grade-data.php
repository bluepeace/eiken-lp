...
function grade_content_all(): array
{
    ...
    $cache = [
        '1kyu' => [
            'level_label' => '大学上級程度',
            'hero_kicker' => '英検対策アプリ',
            'hero_headline' => '1級対策を、本試験形式で。',
            'hero_chips' => ['要約対応', 'インタビュー', '大学上級程度'],
            'hero_lead' => '入試・留学・通訳案内士でも評価される、英検の最終目標です。より高い社会性の読解と、要約・英作文、インタビューまでのリスニングを、単語からスピーキングまで本試験形式で対策できます。',
            'blog_tag_slug' => '英検1級',
            'trust_badges' => [
            ...
            'positioning' => [
                'heading' => '英検1級のレベル｜準1級との違い',
                'lead' => '大学上級程度として、入試・留学・通訳案内士でも評価される最終目標の級です。準1級の「社会生活の幅広い分野」から一歩進み、より高い社会性が問われます。',
                'image' => '/assets/images/grade/1kyu/position-classroom.jpg',
                'image_alt' => 'ペンを手に、画面を見ながら1級の学習を進める女性',
                'image_2' => '/assets/images/grade/1kyu/position-takeaways.jpg',
                'image_2_alt' => 'ノートパソコンの前で、1級の課題を考える女性',
                'highlight' => '1kyu',
                'intro' => [
                    '準1級は<strong>社会生活の幅広い分野</strong>、1級は<strong>より高い社会性</strong>。芸術・文化・歴史・教育・科学・医療・テクノロジー・ビジネス・政治などが、さらに抽象度の高い題材になります。準1級の延長だけでは、語彙と試験の長さ、二次のスピーチが足りません。',
                    '試験時間はリーディング・ライティング100分、リスニング約35分、面接約10分。ライティングは2024年度から<strong>英文要約＋英作文</strong>です。英作文は<strong>立場・理由・結論</strong>の型が求められます。リスニングには準1級にはない<strong>インタビュー</strong>が入り、二次は4コマではなく<strong>スピーチ</strong>です。',
                ],
                'steps' => [
                    ['kicker' => '2級', 'title' => '社会', 'text' => '社会生活に必要な、より広い分野の話題'],
                    ['kicker' => '準1級', 'title' => '社会生活', 'text' => '大学中級。幅広い分野と長い試験'],
                    ['kicker' => '1級', 'title' => 'より高い社会性', 'text' => '大学上級。スピーチのある二次', 'current' => true],
                ],
                'table' => [
                ...
                'takeaways_lead' => '準1級から上がるときに、変わること',
                'takeaways' => [
                    '題材が<strong>社会生活の幅広い分野から、より高い社会性</strong>へ。語彙は約10,000〜15,000語レベルまで上がるのが、いちばんの差です。',
                    '一次は<strong>100分・リスニング約35分</strong>。準1級のReal-Lifeに加え、<strong>インタビュー</strong>が入ります。',
                    '二次は約8分の4コマから、<strong>約10分のスピーチ</strong>（準備1分・スピーチ2分＋Q&amp;A）へ変わります。',
                    'AiKenなら、要約と英作文のAI添削からインタビュー形式のリスニングまで、この級の出題に合わせて対策できます。',
                ],
            ],
            'problems' => [
                'heading' => '1級対策、<span class="heading-accent">こんなお悩み</span>ありませんか？',
                'lead' => '準1級から上がる人にも、入試・留学・通訳案内士で1級が必要な人にも。英検1級、こんなことで止まっていませんか。',
                'buddy_image' => '/assets/images/buddy-worries.png',
                'buddy_alt' => 'AiKenのバディ「チョコ」',
                'items' => [
                    '準1級までできたのに、<strong>語彙と長文</strong>が一段上に感じる',
                    '要約は書けても、英作文の<strong>立場と理由を時間内に書き切れない</strong>',
                    'リスニングに<strong>インタビュー</strong>が入り、先読みとメモが追いつかない',
                    '二次が4コマから<strong>スピーチ</strong>に変わり、型がわからない',
                    '要約や英作文を、その場で<strong>添削できる人がいない</strong>',
                    '<strong>本番に近い形式</strong>で、この級の大問をまとめて練習したい',
                ],
                'solution' => 'だからこそ、<span class="text-brand-accent">要約と英作文</span>も<strong>AIがその場で添削</strong>。より高い社会性の題材を、アプリひとつで。',
            ],
            'strengths' => [
                'heading' => '英検1級対策アプリ' . htmlspecialchars(SITE_NAME) . 'の<span class="heading-accent">7つの強み</span>',
                'lead' => 'さきほどのお悩みを、ひとつのアプリでまとめて解決。',
                'items' => [
                    [
                        'title' => '1級の本試験形式で、大問どおりに',
                        'text' => '単語・リーディング・リスニング・ライティングを、<span class="lp-marker">英検1級の本番に近い形式で出題</span>します。より高い社会性の題材に合わせてあるので、「本当にこの級の対策になっているのかな」という不安も減らせます。教材をバラバラに揃えず、ひとつのアプリで今日やるべきことが明確になります。',
                        'image' => '/assets/images/grade/1kyu/strength-1.jpg',
                        'alt' => '眼鏡をかけて、コーヒーを飲みながらパソコンで学習する男性',
                    ],
                    [
                        'title' => '形式変更後の要約も、類似問題が解き放題',
                        'text' => '2024年度から要約が入り、古い過去問だけではライティングの量が足りないことがあります。<span class="lp-marker">10,000問超</span>の問題数で、同じ形式の類似問題を何度でも解けるので、社会性の高い読解も要約の型も、反復で定着させられます。',
                        'image' => '/assets/images/grade/1kyu/strength-2.jpg',
                        'alt' => '鉛筆を持ち、腕時計を確認しながら学習する男性',
                    ],
                    [
                        'title' => '要約と英作文を、AIがその場で添削',
                        'text' => '1級のライティングは<strong>英文要約と英作文</strong>の2題です。英作文は立場・理由・結論の構成が求められます。書いた直後に、<span class="lp-marker">AIが要点のまとめ方・文法・構成をフィードバック</span>するので、添削してくれる人がいなくても、その日のうちに書いて直せます。準1級の延長では足りない、長さと抽象度をいちばんの不安としてカバーします。',
                        'image' => '/assets/images/grade/1kyu/strength-3.jpg',
                        'alt' => 'ペンを手に、机で考えながら書く女性',
                    ],
                    [
                        'title' => '社会生活から、より高い社会性の題材へ',
                        'text' => '準1級までの延長では足りない、<span class="lp-marker">より高い社会性</span>の読解・リスニングを用意しています。科学・医療・政治・世界経済などが題材になるので、語彙と論理の密度を1級の本番に合わせて上げていけます。',
                        'image' => '/assets/images/grade/1kyu/strength-4.jpg',
                        'alt' => '眼鏡をかけて、ノートとパソコンで学習する女性',
                    ],
                    [
                        'title' => '間違えた問題をあとから復習',
                        'text' => '解いた問題は学習履歴として残るので、<span class="lp-marker">間違えた問題だけをあとから集中的にやり直せます</span>。要約の型も1級の語彙も、一度解いて終わりにせず弱点を潰せます。どこでつまずいているか把握しやすいので、続け方も立てやすいです。',
                        'image' => '/assets/images/grade/1kyu/strength-5.jpg',
                        'alt' => 'イヤホンを着け、パソコンの画面を見て考える女性',
                    ],
                    [
                        'title' => 'スキマ時間にスマホから',
                        'text' => '仕事や研究で忙しい方でも、通勤の電車や待ち時間など、<span class="lp-marker">5〜10分の空き時間で1級の練習</span>ができます。単語やリスニングはスキマで、要約と英作文は自宅で、と役割を分けやすいのもポイントです。',
                        'image' => '/assets/images/grade/1kyu/strength-6.jpg',
                        'alt' => 'ソファでスマホを見て笑う女性',
                    ],
                    [
                        'title' => '最終級まで、同じアプリで足りる',
                        'text' => '1級は英検の最終目標です。準1級で固めた要約と社会生活の話題を、この級の語彙・インタビュー・スピーチへ伸ばせます。級をまたいでも<span class="lp-marker">乗り換え不要</span>。' . FREE_TRIAL_DAYS . '日間は全機能を無料で試せるので、まずは触ってみて、「続けられそうか」を確かめてから始められます。',
                        'image' => '/assets/images/grade/1kyu/strength-7.jpg',
                        'alt' => '青空の下で両手を広げて笑う女性',
                    ],
                ],
            ],
            'mid_cta' => [
                ...
                'lead' => '1級でいちばん差がつくのは、大学上級の語彙と、要約の精度です。学習画面を全部見なくても、登録したその場で本試験形式に触れられます。',
                'note' => 'カード登録不要・1分で完了',
                'secondary_label' => '1級の学習内容を見る',
            ...
            'listening' => [
                'lead' => '放送はすべて1回。会話・説明文に加え、Real-Life形式とインタビューがあり、先読みとメモ取りが得点の鍵です。',
                'tips' => '設問と選択肢を先に眺め、キーワードを意識しながら聞く練習を重ねましょう。インタビューは発言の意図と流れを追います。',
                'parts' => [
                    ...
                    ['title' => 'インタビュー', 'desc' => 'インタビュー全体の流れと発言の意図を捉えます。準1級にはない大問です。', 'image' => 'listening-4'],
                ],
            ],
            'writing' => [
                ...
                'parts' => [
                    ...
                    ['title' => '英作文（意見論述）', 'desc' => '指定トピックについて、立場・理由・結論の型で意見を論述します。', 'image' => 'writing-2'],
                    ['title' => 'AIによるリアルタイム添削', 'desc' => '文法・語彙・構成のフィードバックがその場で届きます。', 'image' => 'writing-3'],
                ],
            ],
            'speaking' => [
                'lead' => '1級の二次は約10分。自由会話のあと、5トピックから1つ選んでスピーチ（準備1分・スピーチ2分）、続けてQ&amp;A（約4分）です。準1級の4コマとは型が違います。AiKenでは本試験に近い形式で繰り返し練習でき、話した内容はAIがその場で採点します。',
                'tips' => '時事・社会問題の立場を先に決め、2分で理由まで言い切る練習を。Q&Aはスピーチの論点を外さないようにしましょう。',
                'parts' => [
                    ['title' => 'スピーチ', 'desc' => '準備1分・スピーチ2分で、選んだトピックについて意見を述べます。準1級の4コマナレーションとは違う型です。', 'image' => 'speaking-1'],
                    ['title' => 'スピーチ後のQ&A', 'desc' => '自分のスピーチ内容について質問されます。理由を短く補い、論点をずらさない練習です。', 'image' => 'speaking-2'],
                    ['title' => '質疑（責任・影響）', 'desc' => '責任や影響を問う追加の質問です。スピーチの立場を崩さず、短く答えます。', 'image' => 'speaking-3'],
                ],
            ],
            'format_plan' => [
                'heading' => '英検1級の出題形式と、<span class="heading-accent">1週間の使い方</span>',
                'lead' => '公式の大問に合わせて練習できます。忙しい週は、通勤で単語とリスニング、夜に要約1本、で十分です。',
                'table' => [
                    'heading' => '本番の大問（目安）',
                    'headers' => ['技能', '大問', '本番の目安'],
                    'rows' => [
                        ['skill' => 'リーディング', 'part' => '短文の語句空所補充', 'note' => '22問'],
                        ['skill' => 'リーディング', 'part' => '長文の語句空所補充', 'note' => '6問'],
                        ['skill' => 'リーディング', 'part' => '長文の内容一致選択', 'note' => '7問'],
                        ['skill' => 'ライティング', 'part' => '英文要約', 'note' => '1題', 'mark' => true],
                        ['skill' => 'ライティング', 'part' => '英作文（立場〜理由〜結論）', 'note' => '1題'],
                        ['skill' => 'リスニング', 'part' => '会話の内容一致選択', 'note' => '10問・放送1回'],
                        ['skill' => 'リスニング', 'part' => '文の内容一致選択', 'note' => '10問・放送1回'],
                        ['skill' => 'リスニング', 'part' => 'Real-Life形式', 'note' => '5問・放送1回'],
                        ['skill' => 'リスニング', 'part' => 'インタビュー', 'note' => '2問・放送1回'],
                        ['skill' => 'スピーキング', 'part' => '二次面接', 'note' => '約10分・スピーチ＋Q&A'],
                    ],
                    'note' => '問題数・時間は日本英語検定協会の公表内容に基づく目安です。最新の出題は公式サイトでご確認ください。',
                ],
                'week' => [
                    'heading' => '忙しい週でも、役割を分ければ続く',
                    'lead' => '毎日1時間じゃなくて大丈夫。スキマ・夜・週末で役割を分けると、仕事のある週でも続きやすいです。',
                    'image' => '/assets/images/grade/1kyu/format-week.jpg',
                    'image_alt' => 'イヤホンを着け、スマホを見ながらメモを取る学生',
                    'roles' => [
                        ['when' => '通勤・待ち時間', 'time' => '5〜10分', 'title' => '単語とリスニング', 'text' => '放送1回とインタビューの本番に慣れる。間違えた語だけ履歴でやり直せます。', 'icon' => 'smartphone'],
                        ['when' => '夜の机', 'time' => '15〜20分', 'title' => '週に1回は要約', 'text' => '書いた直後にAIが添削するので、添削待ちで止まらず、その日のうちに直せます。', 'icon' => 'pencil-line'],
                        ['when' => '週末', 'time' => '20分', 'title' => '英作文かスピーチ', 'text' => '立場と理由を書くか、2分で声に出す。二次の型にもつながります。', 'icon' => 'mic'],
                    ],
                    'days' => [
                        ['day' => '月', 'text' => '単語＋L'],
                        ['day' => '火', 'text' => '単語＋読解'],
            ...
            'target' => [
                'heading' => 'こんな方におすすめです',
                'lead' => '1級は、準1級から上がる人にも、入試・留学・通訳案内士で必要な人にも選ばれています。',
                'items' => [
                    [
                        'title' => '準1級から、1級へ進みたい方',
                        'text' => '形式は似ていても、題材はより高い社会性へ広がります。語彙と、インタビュー・スピーチを、本試験形式で上げられます。',
                        'image' => '/assets/images/target/junior-senior.jpg',
                        'alt' => '次の級に進む学生',
                    ],
                    [
                        'title' => '入試・単位認定で1級を活用したい方',
                        'text' => '大学上級程度として、入試や単位認定で評価される級です。通学のスキマと、自宅での要約・英作文を組み合わせやすいです。',
                        'image' => '/assets/images/target/junior-senior.jpg',
                        'alt' => '入試に向けて学習する学生',
                    ],
                    [
                        'title' => '通訳案内士の免除を目指す方',
                        'text' => '1級合格は、通訳案内士試験の外国語（英語）筆記免除に使えます。忙しい週でも、単語とリスニングはスキマで進められます。',
            ...
            'faq' => [
                ['q' => '準1級と1級の違いは何ですか？', 'a' => '準1級は社会生活の幅広い分野、1級はより高い社会性が中心です。レベル目安は大学中級程度と大学上級程度。一次は90分・約30分から100分・約35分へ延び、リスニングにインタビューが加わります。ライティングはどちらも要約＋英作文です。二次は約8分の4コマから、約10分のスピーチ（準備1分・スピーチ2分＋Q&A）へ変わります。'],
                ['q' => '1級の要約・英作文はアプリで練習できますか？', 'a' => 'はい。英文要約と意見論述の両方に対応し、書いた直後にAIが要点のまとめ方・文法・構成をフィードバックします。英作文は立場・理由・結論の型を、その場で直しながら進められます。'],
                ['q' => '2024年度の形式変更後も、練習できますか？', 'a' => 'はい。1級は2024年度から要約が入りました。古い過去問だけではライティングの量が足りないことがあります。AiKenでは本試験に近い形式の類似問題を繰り返し解けます。本番の過去問そのものは、日本英語検定協会の公式サイトでご確認ください。'],
                ['q' => '二次試験（面接）の練習はできますか？', 'a' => 'はい。二次は約10分で、5トピックから1つ選ぶスピーチ（準備1分・スピーチ2分）とQ&Aがあります。AiKenでは本試験に近い形式で練習でき、話した内容はAIがその場で採点します。本番の面接官ではありませんが、形式と型に慣れる反復に使えます。'],
                ['q' => 'インタビュー形式のリスニングは練習できますか？', 'a' => 'はい。1級のリスニングは会話・文・Real-Lifeに加え、インタビューがあります。放送は1回なので、先読みと要点メモの練習がそのまま得点につながります。'],
                ['q' => '1級の語彙はどのくらい必要ですか？', 'a' => '目安として約10,000〜15,000語レベルの語彙力が求められます。AiKenでは級別の単語を4択で反復し、間違えた問題を履歴から復習できます。'],
                ['q' => '1級だけ、料金は別ですか？', 'a' => 'いいえ。級ごとの料金はありません。1級も、5級〜1級と同じプレミアムプランです。' . (open_campaign_active()
                ...
                ['q' => '入試・留学・通訳案内士の対策にも使えますか？', 'a' => 'はい。1級は大学上級程度として、入試活用・単位認定・海外留学、通訳案内士試験の外国語（英語）筆記免除でも評価される級です。通勤のスキマで単語とリスニング、自宅で要約・英作文とスピーチ、と役割を分けて続けられます。'],
            ],
            'cta' => [
                'heading' => '1級対策を、<span class="heading-accent">' . FREE_TRIAL_DAYS . '日間無料</span>で。',
                'lead' => 'より高い社会性の読解も、要約と英作文も、インタビューも。カード登録なしで、今日から本試験形式に触れられます。準1級から上がる人も、同じアプリで続けられます。',
        ...
        'jun1kyu' => [
            ...
            'positioning' => [
                ...
                'image_alt' => 'ペンを手に、画面を見ながら準1級の学習を考える学生',
                'image_2' => '/assets/images/grade/jun1kyu/position-takeaways.jpg',
                'image_2_alt' => 'ヘッドセットを着け、パソコンで準1級のスピーキング練習をする学生',
                'highlight' => 'jun1kyu',
                'intro' => [
        ...
        '3kyu' => [
            'level_label' => '中学卒業程度',
            'hero_kicker' => '英検対策アプリ',
            'hero_headline' => '3級対策を、本試験形式で。',
            'hero_chips' => ['Eメール対応', '日常的な話題', '中学卒業程度'],
            'hero_lead' => '中学卒業程度の級です。日常的な話題の読解と、Eメール・英作文を、単語からスピーキングまで本試験形式で対策できます。',
            'blog_tag_slug' => '英検3級',
            'trust_badges' => [
                ['icon' => 'sparkles', 'label' => 'AI添削'],
                ['icon' => 'pencil-line', 'label' => 'Eメール'],
            ...
            'positioning' => [
                ...
                'intro' => [
                    ...
                    '試験時間はリーディング・ライティング65分、リスニング約25分、面接約5分。ライティングは2024年度から<strong>Eメール＋英作文</strong>です。4級にはなかった書く力と面接を、本試験形式で慣らす級です。',
                ],
                'steps' => [
                    ['kicker' => '4級', 'title' => '日常', 'text' => '中学中級程度。読解とリスニングが中心'],
                    ['kicker' => '3級', 'title' => '日常', 'text' => '中学卒業。Eメール・英作文と二次面接が加わる', 'current' => true],
                    ['kicker' => '準2級', 'title' => '日常', 'text' => '高校中級。一次が延び、語彙とやりとりが一段長い'],
                ],
                'table' => [
                    'heading' => '4級・3級・準2級の比較',
                    'headers' => ['', '4級', '3級', '準2級'],
                    'header_keys' => ['', '4kyu', '3kyu', 'jun2kyu'],
                    'rows' => [
                        ['レベル目安', '中学中級程度', '中学卒業程度', '高校中級程度'],
                        ['話題', '日常的な話題', '日常的な話題', '日常的な話題'],
                        ['一次（R+W / L）', '35分 / 約30分', '65分 / 約25分', '80分 / 約25分'],
                        ['ライティング', 'なし', 'Eメール＋英作文', 'Eメール＋英作文'],
                        ['二次／スピーキング', '録音型・約4分', '面接・約5分', '面接・約6分・1枚'],
                    ],
                    'note' => '時間・形式の目安は日本英語検定協会の公表内容に基づきます。最新の出題は公式サイトでご確認ください。',
                ],
                'takeaways_lead' => '4級から上がるときに、変わること',
                'takeaways' => [
                    '一次に<strong>ライティング</strong>が入ります。2024年度から<strong>Eメール＋英作文</strong>の2題で、返信の型と短い意見文が問われます。',
                    'リーディング・ライティングは<strong>65分</strong>。4級の読解中心から、読む量と書く量が一段増えるのがいちばんの差です。',
                    '二次は<strong>対面の面接・約5分</strong>。4級の録音型から変わり、パッセージの音読とイラスト描写、身近な質問が続きます。',
                    'AiKenなら、EメールのAI添削から面接練習まで、この級の出題に合わせて対策できます。',
                ],
            ],
            'problems' => [
                'heading' => '3級対策、<span class="heading-accent">こんなお悩み</span>ありませんか？',
                'lead' => '4級からステップアップするあなたへ。英検3級、こんなことで止まっていませんか。',
                'buddy_image' => '/assets/images/buddy-worries.png',
                'buddy_alt' => 'AiKenのバディ「チョコ」',
                'items' => [
                    '2024年から<strong>Eメール</strong>が出て、挨拶・本文・締めの型がわからない',
                    '4級との<strong>差</strong>が大きくて、何から手をつければいいか迷う',
                    'Eメールや英作文を、保護者がその場で<strong>添削できない</strong>',
                    'イラスト付きの<strong>応答文選択</strong>で、流れがつかめず点が伸びない',
                    '高校入試前の基礎固めに3級が必要だが、<strong>本番に近い練習</strong>が足りない',
                    '<strong>本番に近い形式</strong>で、この級の大問をまとめて練習したい',
                ],
                'solution' => 'だからこそ、<span class="text-brand-accent">初めてのEメール</span>も<strong>AIがその場で添削</strong>。本試験形式の問題を、アプリひとつで。',
            ],
            'strengths' => [
                'heading' => '英検3級対策アプリ' . htmlspecialchars(SITE_NAME) . 'の<span class="heading-accent">7つの強み</span>',
                'lead' => 'さきほどのお悩みを、ひとつのアプリでまとめて解決。',
                'items' => [
                    [
                        'title' => '3級の本試験形式で、大問どおりに',
                        'text' => '単語・リーディング・リスニング・ライティングを、<span class="lp-marker">英検3級の本番に近い形式で出題</span>します。日常的な話題の題材に合わせてあるので、「本当にこの級の対策になっているのかな」という不安も減らせます。教材をバラバラに揃えず、ひとつのアプリで今日やるべきことが明確になります。',
                        'image' => '/assets/images/grade/3kyu/strength-1.jpg',
                        'alt' => 'ノートを前に笑顔でポーズする制服の生徒',
                    ],
                    [
                        'title' => '形式変更後のEメールも、類似問題が解き放題',
                        'text' => '2024年度からEメールが入り、古い過去問だけではライティングの量が足りないことがあります。<span class="lp-marker">10,000問超</span>の問題数で、同じ形式の類似問題を何度でも解けるので、日常話題の読解もEメールの型も、反復で定着させられます。',
                        'image' => '/assets/images/grade/3kyu/strength-2.jpg',
                        'alt' => 'ノートにペンで書き進める制服の生徒',
                    ],
                    [
                        'title' => '3級のEメールを、AIがその場で添削',
                        'text' => '3級のライティングは<strong>Eメールと英作文</strong>の2題です。書いた直後に、<span class="lp-marker">AIが条件の満たし方・文法・構成をフィードバック</span>するので、保護者の方が毎回添削しなくても、その日のうちに書いて直せます。挨拶・本文・締めの型を、いちばんの不安としてカバーします。',
                        'image' => '/assets/images/grade/3kyu/strength-3.jpg',
                        'alt' => 'ヘッドホンを首にかけ筆記する制服の生徒',
                    ],
                    [
                        'title' => '日常の話題で、次の級の手前まで慣らす',
                        'text' => '家族・学校・趣味など<span class="lp-marker">日常的な話題</span>の読解・リスニングを用意しています。4級にはなかったEメールや面接の型も、本試験の形式で回せます。準2級の長い日常へ進む前の、土台づくりです。',
                        'image' => '/assets/images/grade/3kyu/strength-4.jpg',
                        'alt' => '先生と生徒が机を囲んで学ぶ様子',
                    ],
                    [
                        'title' => '間違えた問題をあとから復習',
                        'text' => '解いた問題は学習履歴として残るので、<span class="lp-marker">間違えた問題だけをあとから集中的にやり直せます</span>。Eメールの型も日常の語彙も、一度解いて終わりにせず弱点を潰せます。どこでつまずいているか把握しやすいので、保護者の方も安心です。',
                        'image' => '/assets/images/grade/3kyu/strength-5.jpg',
                        'alt' => 'ノートPCを見ながら学習する制服の生徒',
                    ],
                    [
                        'title' => 'スキマ時間にスマホから',
                        'text' => '部活や塾で忙しいお子さんでも、通学の電車や待ち時間など、<span class="lp-marker">5〜10分の空き時間で3級の練習</span>ができます。単語やリスニングはスキマで、Eメールは自宅で、と役割を分けやすいのもポイントです。',
                        'image' => '/assets/images/grade/3kyu/strength-6.jpg',
                        'alt' => 'タブレットを立ててノートに書く制服の生徒',
                    ],
                    [
                        'title' => '次の準2級も、同じアプリで続けられる',
                        'text' => '3級で固めた日常の語彙とEメールの型は、次の級でも活きます。級が上がっても<span class="lp-marker">乗り換え不要</span>。' . FREE_TRIAL_DAYS . '日間は全機能を無料で試せるので、まずはお子さんと一緒に触ってみて、「続けられそうか」を確かめてから始められます。',
                        'image' => '/assets/images/grade/3kyu/strength-7.jpg',
                        'alt' => '授業を聞く制服の生徒',
                    ],
                ],
            ],
            'mid_cta' => [
                'heading' => 'まずはEメールと単語を、<span class="heading-accent">' . FREE_TRIAL_DAYS . '日間無料</span>で。',
                'lead' => '3級でいちばん差がつくのは、日常の語彙と、2024年から入ったEメールです。学習画面を全部見なくても、登録したその場で本試験形式に触れられます。',
                'note' => 'カード登録不要・1分で完了',
                'secondary_label' => '3級の学習内容を見る',
                'secondary_href' => '#grade-skill-word',
            ],
            'sections' => ['word', 'reading', 'listening', 'writing', 'speaking'],
            'word' => [
                'lead' => '家族・学校・趣味など身近な場面の語彙が中心。4択でテンポよく回し、間違えた語だけ履歴で復習するのが効率的です。',
                'vocab_note' => '想定語彙は約2,100〜2,500語レベル。基本動詞・場面語を優先して固めましょう。',
                'points' => $wordCommonPoints,
                'images' => [
                    ['key' => 'word-1', 'caption' => '4択で意味を選ぶ'],
                    ['key' => 'word-2', 'caption' => '正誤と解説がその場で表示'],
            ...
            'reading' => [
                'lead' => '短文空所・会話空所・長文内容一致。掲示・案内、Eメール、説明文など、身近な英文が中心です。',
            ...
            'listening' => [
                'lead' => '応答文選択・会話の内容一致・文の内容一致。応答文は放送1回、内容一致は放送2回です。1回目で大意、2回目で細部確認が有効です。',
                'tips' => '応答文はイラストと会話の流れをセットでイメージすると選びやすくなります。',
                'parts' => [
                    ['title' => '会話の応答文選択', 'desc' => '補助イラスト付き。最後の発話への適切な応答を選びます（放送1回）。', 'image' => 'listening-1'],
                    ['title' => '会話の内容一致選択', 'desc' => '会話の内容に関する質問に答えます（放送2回）。', 'image' => 'listening-2'],
                    ['title' => '文の内容一致選択', 'desc' => '短いパッセージの内容を聞き取ります（放送2回）。', 'image' => 'listening-3'],
                ],
            ],
            'writing' => [
                'lead' => '2024年度からEメールが追加され、英作文とあわせて2題。返信の型と、理由付きの短い意見文が基本です。AiKenではAIがリアルタイム添削します。',
                'tips' => 'Eメールは挨拶・本文・締めの型と条件漏れ防止。英作文は中学文法で十分です。',
                'parts' => [
                    ['title' => 'Eメール', 'desc' => '依頼・質問への返信メールを英文で書きます。', 'image' => 'writing-1'],
            ...
            'speaking' => [
                'lead' => '3級の二次は約5分。30語程度のパッセージの音読、パッセージの質問、イラストの行動・状況描写、身近な事柄についての質問の流れです。AiKenでは本試験に近いカード形式で繰り返し練習でき、話した内容はAIがその場で採点します。',
                'tips' => 'イラストは「誰が何をしているか」を短く。身近な質問はYes/Noに理由を1文添えると答えやすいです。',
                'parts' => [
                    ['title' => 'パッセージとイラスト', 'desc' => '問題カードのパッセージ音読と、イラストの行動・状況描写の練習です。本番前半に近い流れです。', 'image' => 'speaking-1'],
                    ['title' => '身近な事柄の質問', 'desc' => 'カードを見ずに、身近な話題について短く答えます。本番の後半に近い練習です。', 'image' => 'speaking-2'],
                    ['title' => '自分のこと', 'desc' => '好きなものや休日の過ごし方など、自分の経験で答えます。短い文で理由を添える練習です。', 'image' => 'speaking-3'],
                ],
            ],
            'format_plan' => [
                'heading' => '英検3級の出題形式と、<span class="heading-accent">1週間の使い方</span>',
                'lead' => '公式の大問に合わせて練習できます。忙しい週は、通学で単語とリスニング、夜にEメール1本、で十分です。',
                'table' => [
                    'heading' => '本番の大問（目安）',
                    'headers' => ['技能', '大問', '本番の目安'],
                    'rows' => [
                        ['skill' => 'リーディング', 'part' => '短文の語句空所補充', 'note' => '15問'],
                        ['skill' => 'リーディング', 'part' => '会話文の空所補充', 'note' => '5問'],
                        ['skill' => 'リーディング', 'part' => '長文の内容一致選択', 'note' => '10問'],
                        ['skill' => 'ライティング', 'part' => 'Eメール', 'note' => '1題', 'mark' => true],
                        ['skill' => 'ライティング', 'part' => '英作文（意見論述）', 'note' => '1題'],
                        ['skill' => 'リスニング', 'part' => '会話の応答文選択', 'note' => '10問・放送1回'],
                        ['skill' => 'リスニング', 'part' => '会話の内容一致選択', 'note' => '10問・放送2回'],
                        ['skill' => 'リスニング', 'part' => '文の内容一致選択', 'note' => '10問・放送2回'],
                        ['skill' => 'スピーキング', 'part' => '二次面接', 'note' => '約5分・音読＋イラスト＋質問'],
                    ],
                    'note' => '問題数・時間は日本英語検定協会の公表内容に基づく目安です。最新の出題は公式サイトでご確認ください。',
                ],
                'week' => [
                    'heading' => '忙しい週でも、役割を分ければ続く',
                    'lead' => '毎日1時間じゃなくて大丈夫。スキマ・夜・週末で役割を分けると、部活のある週でも続きやすいです。',
                    'image' => '/assets/images/grade/3kyu/format-week.jpg',
                    'image_alt' => 'ノートPCで学習する制服の生徒',
                    'roles' => [
                        ['when' => '通学・待ち時間', 'time' => '5〜10分', 'title' => '単語とリスニング', 'text' => '応答文と2回放送の本番に慣れる。間違えた語だけ履歴でやり直せます。', 'icon' => 'smartphone'],
                        ['when' => '夜の机', 'time' => '15〜20分', 'title' => '週に1回はEメール', 'text' => '書いた直後にAIが添削するので、保護者の方が見なくてもその日のうちに直せます。', 'icon' => 'pencil-line'],
                        ['when' => '週末', 'time' => '20分', 'title' => '英作文か面接', 'text' => '意見を書くか、イラスト描写を声に出す。次の級の二次にもつながる型です。', 'icon' => 'mic'],
                    ],
                    'days' => [
                        ['day' => '月', 'text' => '単語＋L'],
                        ['day' => '火', 'text' => '単語＋読解'],
            ...
            'target' => [
                'heading' => 'こんな方におすすめです',
                'lead' => '3級は、4級から上がる人にも、高校入試前の基礎固めにも選ばれています。',
                'items' => [
                    [
                        'title' => '4級から、3級へ進みたい方',
                        'text' => '日常の話題は同じでも、ライティングと面接が加わります。Eメールの型を、本試験形式で固められます。',
                        'image' => '/assets/images/target/elementary.jpg',
                        'alt' => '次の級に進む中学生',
                    ],
                    [
                        'title' => '高校入試前に、3級を取りたい方',
                        'text' => '入試前の基礎固めとしてよく使われる級です。通学のスキマと、自宅でのEメール練習を組み合わせやすいです。',
                        'image' => '/assets/images/target/junior-senior.jpg',
                        'alt' => '高校入試に向けて学習する中学生',
                    ],
                    [
                        'title' => '中学生の家庭学習に使いたい方',
                        'text' => '4択単語や短い読解から始められ、ライティングはAI添削で保護者の負担を減らせます。',
                        'image' => '/assets/images/target/daily.jpg',
                        'alt' => '家庭で学習する中学生',
                    ],
                    [
                    ...
                    [
                        'title' => '最終目標は準2級、という方',
                        'text' => '3級で固めた日常の語彙とEメールの型は、次の級でも活きます。級が上がっても同じアプリで続けられます。',
                        'image' => '/assets/images/grade/3kyu/strength-7.jpg',
                        'alt' => '授業を聞く制服の生徒',
                    ],
                ],
            ...
            'faq' => [
                ['q' => '4級と3級の違いは何ですか？', 'a' => 'どちらも日常的な話題が中心ですが、3級は中学卒業程度です。一次にライティング（Eメール＋英作文）が入り、リーディング・ライティングは65分です。二次は対面の面接・約5分で、4級の録音型から変わります。次の準2級では一次が80分に延び、語彙とやりとりが一段長くなります。'],
                ['q' => '3級のEメール・英作文はアプリで練習できますか？', 'a' => 'はい。2024年度から追加されたEメールと、意見論述の英作文の両方に対応し、書いた直後にAIが条件の満たし方・文法・構成をフィードバックします。挨拶・本文・締めの型を、その場で直しながら覚えられます。'],
                ['q' => '2024年度の形式変更後も、練習できますか？', 'a' => 'はい。3級は2024年度からEメールが入り、一次も50分から65分に延びました。古い過去問だけではライティングの量が足りないことがあります。AiKenでは本試験に近い形式の類似問題を繰り返し解けます。本番の過去問そのものは、日本英語検定協会の公式サイトでご確認ください。'],
                ['q' => '二次試験（面接）の練習はできますか？', 'a' => 'はい。二次は約5分で、パッセージの音読、パッセージの質問、イラストの行動・状況描写、身近な事柄についての質問が出ます。AiKenでは本試験に近いカード形式で練習でき、話した内容はAIがその場で採点します。本番の面接官ではありませんが、形式と型に慣れる反復に使えます。'],
                ['q' => '3級だけ、料金は別ですか？', 'a' => 'いいえ。級ごとの料金はありません。3級も、5級〜1級と同じプレミアムプランです。' . (open_campaign_active()
                    ? '今なら' . monthly_price_label() . 'です（OPEN記念価格・定価' . monthly_price_regular_label() . '・' . open_campaign_end_label() . 'まで）。'
                    : monthly_price_regular_label() . 'です。')
                    . '詳細は料金ページをご覧ください。'],
                ['q' => '無料で始められますか？', 'a' => '登録から' . FREE_TRIAL_DAYS . '日間は全機能無料です。カード登録は不要で、会員登録の時点では課金は発生しません。'],
                ['q' => '中学生・高校入試の対策にも使えますか？', 'a' => 'はい。3級は高校入試前の基礎固めとしてもよく使われる級です。通学のスキマで単語とリスニング、自宅でEメールと面接、と役割を分けて続けられます。'],
                ['q' => '次の目標が準2級でも、この級から始めてよいですか？', 'a' => 'はい。3級で固めた日常の語彙とEメールの型は、次の級でも活きます。準2級は一次が長く語彙も一段上がるので、まずはこの級の形式で慣らしておくと次につながります。級が上がっても同じアプリで続けられます。'],
                ['q' => '保護者がEメールを添削できなくても大丈夫ですか？', 'a' => 'はい。書いた内容はAIがその場で添削するので、保護者の方が毎回見なくても、その日のうちに直して次へ進めます。間違えた問題は履歴から復習できます。'],
            ],
            'cta' => [
                'heading' => '3級対策を、<span class="heading-accent">' . FREE_TRIAL_DAYS . '日間無料</span>で。',
                'lead' => '日常の話題の読解も、Eメールも、イラストの面接も。カード登録なしで、今日から本試験形式に触れられます。最終目標が準2級でも、同じアプリで続けられます。',
                'button' => FREE_TRIAL_DAYS . '日間無料で試す',
                'secondary_label' => '料金を見る',
                'secondary_href' => '/plan',
                'note' => 'カード登録不要・1分で完了',
