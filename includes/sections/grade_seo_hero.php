...
$hero_headline = $grade_content['hero_headline'] ?? ($name . '対策を、本試験形式で。');
...
?>
<section class="grade-seo-hero relative overflow-hidden px-4 py-10 sm:py-12 md:py-16" aria-labelledby="grade-seo-hero-heading">
