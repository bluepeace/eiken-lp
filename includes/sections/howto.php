...
<section class="border-t border-slate-100 bg-white px-4 py-16 sm:py-20" aria-labelledby="howto-heading">
  <div class="mx-auto max-w-3xl text-center">
    ...
    <p class="mt-3 text-slate-600">会員登録ですぐに使えます。クレジットカード不要。</p>
    <ol class="mt-10 space-y-6">
      <li class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/50 p-5 text-left">
        ...
        <div>
          ...
          <p class="text-sm text-slate-600">メールアドレスで無料登録</p>
        </div>
      </li>
      <li class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/50 p-5 text-left">
        ...
        <div>
          <p class="font-semibold text-slate-900">目標級を選択</p>
          <p class="text-sm text-slate-600">英検5級〜1級から選択</p>
        </div>
      </li>
      <li class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/50 p-5 text-left">
        ...
        <div>
          <p class="font-semibold text-slate-900">今日のおすすめから始める</p>
          <p class="text-sm text-slate-600">単語・ライティングなど、提案に沿って学習</p>
        </div>
      </li>
    </ol>
