    ...
    <ol class="mt-10 space-y-6">
      <li class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/50 p-5 text-left">
        ...
        <div>
          ...
          <p class="text-sm text-slate-600"><?php echo br_after_period('メールアドレスで無料登録。すぐに利用開始できます。'); ?></p>
        </div>
      </li>
      <li class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/50 p-5 text-left">
        ...
        <div>
          ...
          <p class="text-sm text-slate-600"><?php echo br_after_period('英検5級〜1級から選択。級別の対策が始まります。'); ?></p>
        </div>
      </li>
      <li class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/50 p-5 text-left">
        ...
        <div>
          ...
          <p class="text-sm text-slate-600"><?php echo br_after_period('単語・ライティング・リーディングなど、提案に沿って進められます。'); ?></p>
        </div>
      </li>
    </ol>
