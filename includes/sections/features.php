...
$strength_items = [
    [
        'title' => '本試験形式で英語4技能＋単語',
        'text' => '単語・リーディング・リスニング・ライティング・スピーキングを、<span class="lp-marker">英検の本番に近い形式で出題</span>します。級ごとに求められる形式に合わせて練習できるので、「本当に英検対策になっているのかな」という不安も減らせます。教材やアプリをバラバラに揃える必要がなく、ひとつのアプリで英語4技能＋単語の対策が完結。お子さんが今日何をすればよいかも、迷いにくい設計です。',
