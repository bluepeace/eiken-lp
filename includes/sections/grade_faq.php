...
<section class="faq-section border-t border-slate-100 px-4 py-16 sm:py-20" aria-labelledby="grade-faq-heading">
  <div class="faq-section__inner">
    ...
    <h2 id="grade-faq-heading" class="text-center text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">よくある質問</h2>
    <p class="faq-section__lead mt-3 text-center"><?php echo br_after_period(htmlspecialchars($name, ENT_QUOTES, 'UTF-8') . '対策アプリや、料金・使い方についてまとめました。'); ?></p>
